...
require_relative 'SDorHD'
require_relative 'Photo_Naming_Pashua-SD'
require_relative 'Photo_Naming_Pashua–HD'
require_relative 'gpsYesPashua'
...
### Problem if import from other than my card because record is wrong. Need to have a temporary import where the last card and file aren't changed.
### NEED TO KEEP MAC AWAKE, AS SCRIPT STOPS WHEN COMPUTER SLEEPS
# version d: stopped loading requires, so added so stuff found on the net. Added variable to select difference method. Should make it part of the Pashua stuff
